...
class ValueNetSmall(nn.Module):
    def __init__(self, num_blocks=6, channels=64, input_planes=2):
        super(ValueNetSmall, self).__init__()
        
        # Initial convolution
        # Input shape: [Batch, 2, 19, 19] -> [Batch, 64, 19, 19]
